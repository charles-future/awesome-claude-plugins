...
- [toprank](https://github.com/nowork-studio/toprank) - Open-source (MIT) SEO and Google Ads plugin for Claude Code. Connects Google Search Console, PageSpeed Insights, and Google Ads API to perform SEO audits, keyword research, meta tag optimization, schema markup generation, and ad campaign management directly from Claude Code.
